...
async function estimateGas(contractAddress, playerAddress, url) {
  console.log(contractAddress, playerAddress, url);
  ...
  let abi = [
    ...
    },
    {
      ...
      outputs: [
        {
          internalType: "contract ITuringHelper",
          name: "",
          type: "address",
        },
      ],
  ...
  let erc721 = new web3.eth.Contract(abi, contractAddress);
